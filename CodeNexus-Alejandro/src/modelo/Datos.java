...
public class Datos {
    ...
    public static void showInscripcion(List<Inscripcion> listaInscripciones, List<Socio> listaSocios) {
        ...
        switch (opcion) {
            case 1:
                ...
                break;
            case 2:
                mostrarPorTipoSocio(listaInscripciones, listaSocios);
                break;
            case 3:
                mostrarPorFecha(listaInscripciones);
                break;
            case 4:
                mostrarPorTipoSocioYFecha(listaInscripciones, listaSocios);
                break;
            default:
                System.out.println("Opción no válida.");
                break;
    ...
    // Función para mostrar todas las inscripciones
    ...
    // Función para mostrar inscripciones filtradas por socio
    public static void mostrarPorTipoSocio(List<Inscripcion> listaInscripciones, List<Socio> listaSocios) {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Seleccione el tipo de socio:");
        System.out.println("1. Estándar");
        System.out.println("2. Federado");
        System.out.println("3. Infantil");
        int opcionTipoSocio = scanner.nextInt();
        scanner.nextLine(); // Consumir el salto de línea

        String tipoSocioSeleccionado;
        switch (opcionTipoSocio) {
            case 1:
                tipoSocioSeleccionado = "Estandar";
                break;
            case 2:
                tipoSocioSeleccionado = "Federado";
                break;
            case 3:
                tipoSocioSeleccionado = "Infantil";
                break;
            default:
                System.out.println("Opción no válida.");
        ...
        // Iterar sobre la lista de inscripciones y mostrar solo las del tipo de socio seleccionado
        for (Inscripcion inscripcion : listaInscripciones) {
            for (Socio socio : listaSocios) {
                if (socio.getTipoSocio().equals(tipoSocioSeleccionado) && inscripcion.getIdSocio() == socio.getIdSocio()) {
    ...
    // Función para mostrar inscripciones filtradas por fecha
    public static void mostrarPorFecha(List<Inscripcion> listaInscripciones) {
        Scanner scanner = new Scanner(System.in);
        ...
        try {
            ...
            // Iterar sobre la lista de inscripciones y mostrar solo las de la fecha especificada
            for (Inscripcion inscripcion : listaInscripciones) {
    ...
    // Función para mostrar inscripciones con filtro por tipo de socio y fecha
    public static void mostrarPorTipoSocioYFecha(List<Inscripcion> listaInscripciones, List<Socio> listaSocios) {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Seleccione el tipo de socio:");
        System.out.println("1. Estándar");
        System.out.println("2. Federado");
        ...
        try {
            ...
            System.out.println("Formato de fecha incorrecto.");
            return; // Salir de la función si el formato de fecha es incorrecto
        }

        // Iterar sobre la lista de inscripciones y mostrar solo las del tipo de socio seleccionado y en la fecha especificada
        for (Inscripcion inscripcion : listaInscripciones) {
            for (Socio socio : listaSocios) {
                if (socio.getTipoSocio().equals(tipoSocioSeleccionado) && inscripcion.getIdSocio() == socio.getIdSocio() && inscripcion.getFechaInscripcion().equals(fecha)) {
                    System.out.println(inscripcion);
                }
            }
        }
